...
set ylabel 'GB/s'
plot \
  p( 8,1, 'CPU') u 1:10 w l ls  1 t 'V= 8, M=1, CPU', \
  p( 8,2, 'CPU') u 1:10 w l ls 21 t 'V= 8, M=2, CPU', \
  ...
  p( 8,1,'GPU5') u 1:10 w l ls  5 t 'V= 8, M=1, GPU T/B=32', \
  p( 8,2,'GPU5') u 1:10 w l ls 25 t 'V= 8, M=2, GPU T/B=32', \
