...
set ylabel 'GB/s'
plot \
  p( 4,1, 'CPU') u 1:10 w l ls  1 t 'V= 4, M=1, CPU', \
  p( 4,2, 'CPU') u 1:10 w l ls 21 t 'V= 4, M=2, CPU', \
  ...
  p(64,1, 'CPU') u 1:10 w l ls  4 t 'V=32, M=1, CPU', \
  p(64,2, 'CPU') u 1:10 w l ls 24 t 'V=32, M=2, CPU', \
  p( 4,1,'GPU5') u 1:10 w l ls  5 t 'V= 4, M=1, GPU T/B=32', \
  p( 4,2,'GPU5') u 1:10 w l ls 25 t 'V= 4, M=2, GPU T/B=32', \
  p(16,1,'GPU5') u 1:10 w l ls  6 t 'V=16, M=1, GPU T/B=32', \
